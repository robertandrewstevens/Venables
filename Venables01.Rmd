...
- The working directory may contain sub-directories for natural entities such as Data, Fig, Archive, Scripts, Code, etc.
...
- Generic manipulations (print, plot, summary, etc.) have their detailed operation determined by the class of the objects on which they act.
