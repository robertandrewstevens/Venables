...
# Predict the probability of low birth weight with varying age and ftv, 
# and other variables at or near their modal value.
...
# To bring the predictions closer to the actual data, confine the 
# predictions to age ranges that apply within the levels of ftv
